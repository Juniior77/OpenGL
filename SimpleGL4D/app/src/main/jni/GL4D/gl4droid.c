...
#define  GL4DROID_LOGI(...)  __android_log_print(ANDROID_LOG_INFO,  LOG_TAG, __VA_ARGS__)
#define  GL4DROID_LOGE(...)  __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, __VA_ARGS__)
        ...
        if (!compiled) {
            ...
            if (infoLen) {
                ...
                if (buf) {
                    ...
                    GL4DROID_LOGE("Could not compile %s shader :\n%s\n",
        ...
        if (linkStatus != GL_TRUE) {
            ...
            if (bufLength) {
                ...
                if (buf) {
                    ...
                    GL4DROID_LOGE("Could not link program:\n%s\n", buf);
                    free(buf);
                }
            }
